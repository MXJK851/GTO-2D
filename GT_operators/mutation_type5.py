...
By Qichen Xu
'''
def mu_type5(winner_list,atom_number,atom_x_size,atom_y_size):
    ...
    index_crossover_1= np.sort(np.random.randint(0,len(mom_data_4)-int(int(atom_x_size*atom_x_size)/4)-1,3))[0]

    rs = torch.rand(1)
    if rs<=0.2:
        part_1 = np.concatenate((mom_data_1[index_crossover_1:index_crossover_1+int(int(atom_x_size*atom_x_size)/4),:] ,mom_data_1[index_crossover_1:index_crossover_1+int(int(atom_x_size*atom_x_size)/4),:]))
        part_2 = np.concatenate((mom_data_1[index_crossover_1:index_crossover_1+int(int(atom_x_size*atom_x_size)/4),:] ,mom_data_1[index_crossover_1:index_crossover_1+int(int(atom_x_size*atom_x_size)/4),:]))
    elif 0.2<rs<=0.5:
